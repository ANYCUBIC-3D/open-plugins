...
#include "wx/translation.h"
    ...
    #include "osx/webviewhistoryitem_webkit.h"
#elif defined(__WXGTK__)
    #include "gtk/webviewhistoryitem_webkit.h"
#elif defined(__WXMSW__)
    #include "msw/webviewhistoryitem_ie.h"
#else
...
public:
    ...
    virtual void StartRequest(wxWebViewHandlerRequest& request,
