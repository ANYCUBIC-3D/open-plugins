...
extern const char wxWebViewNameStr[] = "wxWebView";
extern const char wxWebViewDefaultURLStr[] = "about:blank";
extern const char wxWebViewBackendIE[] = "wxWebViewIE";
extern const char wxWebViewBackendEdge[] = "wxWebViewEdge";
extern const char wxWebViewBackendWebKit[] = "wxWebViewWebKit";

#ifdef __WXMSW__
extern const char wxWebViewBackendDefault[] = "wxWebViewEdge";
#else
extern const char wxWebViewBackendDefault[] = "wxWebViewWebKit";
#endif
...
wxDEFINE_EVENT( wxEVT_WEBVIEW_DOWNLOAD_START, wxWebViewEvent);
wxDEFINE_EVENT( wxEVT_WEBVIEW_DOWNLOAD_FINISHED, wxWebViewEvent);
wxDEFINE_EVENT( wxEVT_WEBVIEW_DOWNLOAD_SUGGESTED, wxWebViewEvent);
...
bool wxWebViewConfiguration::ClearCookies(void){
...
void wxWebViewHandler::StartRequest(wxWebViewHandlerRequest& request,
...
{
    auto value = std::getenv(DEVTOOL_ENALBED);
    bool enable = value && strcmp(value,"1") ==0;
    EnableContextMenu(enable);
    EnableAccessToDevTools(enable);
...
#elif USE_WEBVIEW_WEBKIT || USE_WEBVIEW_WEBKIT2
