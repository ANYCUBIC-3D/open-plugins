...
macro(add_shared sub_project_name MACRO_NAME)
    ...
    generate_export_header(${sub_project_name} EXPORT_MACRO_NAME ${MACRO_NAME} EXPORT_FILE_NAME ${sub_project_name}_export.hxx)
    file_install(${sub_project_name} ${CMAKE_BINARY_DIR}/${sub_project_name}/${sub_project_name}_export.hxx)
endmacro()
